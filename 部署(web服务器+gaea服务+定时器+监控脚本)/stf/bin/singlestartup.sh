...
USAGE="Usage: startup.sh <service-name>"
SYSTEM_PROPERTY=""
...
# main class
MAIN_CLASS=cn.hofan.spat.scheduler.bootstrap.Main


java $JAVA_OPTS -classpath $CLASS_PATH -Duser.dir=$DIR $SYSTEM_PROPERTY $MAIN_CLASS $OTHER_SCH_CONFIG -Dsch.service.name=$SERVICE_NAME &
